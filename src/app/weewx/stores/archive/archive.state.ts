...
export class ArchiveState {
    ...
    getArchivesForLast24Hours(ctx: StateContext<ArchiveStateModel>) {
        this.weeWXService.getArchivesForLast24Hours().subscribe((results) => {
            ctx.setState(produce((draft: ArchiveStateModel) => {
    ...
    getArchivesFrom(ctx: StateContext<ArchiveStateModel>, action: GetArchivesFrom) {
